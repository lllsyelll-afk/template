...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex items-center gap-2 data-[state=open]:bg-muted focus:bg-muted px-2 py-1.5 rounded-sm outline-none [&_svg]:size-4 text-sm cursor-default [&_svg]:pointer-events-none select-none [&_svg]:shrink-0",
      inset && "pl-8",
      className,
    )}
    {...props}
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      avoidCollisions
      className={cn(
        "z-50 bg-popover shadow-brutal p-1 border-2 border-border rounded-xl overflow-x-hidden overflow-y-auto text-popover-foreground",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex items-center gap-2 focus:bg-muted data-disabled:opacity-50 px-2 py-1.5 rounded-sm outline-none [&>svg]:size-4 focus:text-muted-foreground text-sm cursor-default data-disabled:pointer-events-none select-none [&>svg]:shrink-0",
      inset && "pl-8",
      className,
    )}
    {...props}
