...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      "p-1 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 overflow-hidden **:[[cmdk-group-heading]]:font-medium **:[[cmdk-group-heading]]:text-muted-foreground **:[[cmdk-group-heading]]:text-xs",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex items-center gap-2 data-[selected=true]:bg-muted data-[disabled=true]:opacity-50 px-2 py-1.5 rounded-sm outline-none [&_svg]:size-4 data-[selected=true]:text-muted-foreground text-sm cursor-default [&_svg]:pointer-events-none data-[disabled=true]:pointer-events-none select-none [&_svg]:shrink-0",
      className,
    )}
    {...props}
  />
